...
def get_dhcp_interface_config_file(iface: str) -> str:
    return (
        "# autogenerated\n"
...
def set_dhcp_node_network_interfaces(server: Server, project: Project, node_id: str, iface_name: str) -> None:
    """Configure the /etc/network/interfaces file for the node."""
    ...
    new_line = get_dhcp_interface_config_file(iface_name)
