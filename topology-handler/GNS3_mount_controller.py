...
def mountController(PROJECT_NAME,CONTROLLER_NAME,switch_name,start_command,ip,gateway):
    ...
    set_node_network_interfaces(server, project, controller_id, "eth0", ipaddress.IPv4Interface("192.168.1.1/24"), "192.168.122.1")
    ...
    print(f"{CONTROLLER_NAME}: DHCP on eth1")
