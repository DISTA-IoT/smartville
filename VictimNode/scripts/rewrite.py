...
if __name__ == "__main__":
    ...
    input_file_name = 'VictimNode/'+PATTERN_TO_REWRITE+'/'+PATTERN_TO_REWRITE+'.pcap'
    output_file_name = 'VictimNode/'+PATTERN_TO_REWRITE+'/'+PATTERN_TO_REWRITE+'-from'+SOURCE_IP+'to'+TARGET_IP+'.pcap'
